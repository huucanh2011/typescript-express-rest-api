...
const firstUserBody = {
  email: `canh.nguyen+${shortid.generate()}@gmail.com`,
  password: 'password'
}

let accessToken = '';
let refreshToken = '';
const newFirstName = 'Canh';
const newFirstName2 = 'Canh2';
const newLastName2 = 'Nguyen';
...
describe('users and auth endpoints', function() {
  ...
  describe('with a valid access token', function() {
    ...
    it ('show disallow a PATCH to /users/:userId', async function() {
      const res = await request
